...
References
[1] A. Krizhevsky, I. Sutskever, und G. E. Hinton, ?žImageNet classification with deep convolutional neural networks??
    Commun. ACM, Bd. 60, Nr. 6, S. 84??0, Mai 2017, doi: 10.1145/3065386.
[2] K. He, X. Zhang, S. Ren, und J. Sun, ?žDeep Residual Learning for Image Recognition?? in 2016 IEEE Conference on
    Computer Vision and Pattern Recognition (CVPR), Las Vegas, NV, USA, Juni 2016, S. 770??78. doi: 10.1109/CVPR.2016.90.
[3] G. SlapniÄar, N. Mlakar, und M. LuÅ¡trek, ?žBlood Pressure Estimation from Photoplethysmogram Using a Spectro-Temporal
