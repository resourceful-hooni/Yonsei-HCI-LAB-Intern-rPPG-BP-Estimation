"""
visualize_multi_task.py - Visualize Multi-Task Learning Results
Phase 3-2: Multi-Task Learning Visualization
"""
...
def load_model_and_data():
    ...
    model = tf.keras.models.load_model('models/multi_task_bp_model.h5')
...
def evaluate_model(model, test_x, test_y):
    ...
    hr_pred = predictions[2].flatten()
    spo2_pred = predictions[3].flatten()
...
def create_visualizations(sbp_pred, dbp_pred, sbp_true, dbp_true):
    ...
    plt.tight_layout()
    plt.savefig('results/mtl_predictions.png', dpi=300, bbox_inches='tight')
    print("   [OK] Saved: results/mtl_predictions.png")
    plt.close()
    ...
    plt.tight_layout()
    plt.savefig('results/mtl_error_distribution.png', dpi=300, bbox_inches='tight')
    print("   [OK] Saved: results/mtl_error_distribution.png")
    plt.close()
...
def create_summary_report(mae_sbp, mae_dbp):
    ...
    report = f"""
================================================================================
MULTI-TASK LEARNING (MTL) - Phase 3-2 Summary Report
================================================================================

Model: Multi-Task Learning (BP + HR + SpO2)
...
Notes:
  ...
  - Weighted loss: BP 1.0 each, HR 0.3, SpO2 0.3
  - Training convergence at 20 epochs
  
================================================================================
NEXT STEPS
================================================================================

1. Integrate with camera capture (Phase 3-3)
2. Real-time BP estimation on video
3. Performance optimization for edge devices (Phase 5)
4. Deployment on mobile/embedded platforms

================================================================================
"""
    
    with open('results/mtl_summary_report.txt', 'w', encoding='utf-8') as f:
        f.write(report)
    
    print("   [OK] Saved: results/mtl_summary_report.txt")


def main():
    parser = argparse.ArgumentParser(description='Visualize Multi-Task Learning Results')
    args = parser.parse_args()
    
    print("\n" + "="*60)
    print("Multi-Task Learning Visualization")
    print("="*60)
    ...
    print("="*60)
    print("\nGenerated files:")
    print("  - results/mtl_predictions.png")
    print("  - results/mtl_error_distribution.png")
    print("  - results/mtl_summary_report.txt")
